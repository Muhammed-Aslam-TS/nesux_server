...
export const loginOwner = async (req, res) => {
  try {
    ...
    console.log(owner,"________________________");
    ...
    console.log(isPasswordValid,"_________________password encrypted");
...
export const updateOwnerInfo = async (req, res) => {
  try {
    ...
    console.log("Update Request:", { primaryDomain, domain });
