...
export const getAllProducts = async (req, res) => {
  try {
    ...
    console.log(products,"_________products");
...
export const createProduct = async (req, res) => {
  try {
    ...
    console.log("--- Creating New Product (multipart/form-data) ---");
    ...
    try {
      ...
      if (saveError.code === 11000 && 
        ...
        console.warn(`⚠️ Legacy '${indexToDrop}' index detected causing conflicts. Dropping index...`);
        try {
          await Product.collection.dropIndex(indexToDrop);
          console.log(`✅ Legacy index '${indexToDrop}' dropped. Retrying save...`);
          await newProduct.save();
        } catch (dropError) {
          console.error(`❌ Failed to drop legacy index '${indexToDrop}':`, dropError);
...
export const updateProduct = async (req, res) => {
  try {
    ...
    console.log(`--- Updating Product: ${id} for Owner: ${ownerId} ---`);
    ...
    const {
     ...
     console.log("Request files:or product----------", req.files);
