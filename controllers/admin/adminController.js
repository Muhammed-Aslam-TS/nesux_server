...
console.log('varndoooooooo___________');
...
export const adminLogin = async (req, res) => {
  try {
    console.log(req.body, ":req.body_____________");
...
export const createOwner = async (req, res) => {
  try {
    ...
    await newOwner.save();
    console.log(newOwner, ":newOwner_____________");
    ...
    console.log(subscription, "subscription___________________");
